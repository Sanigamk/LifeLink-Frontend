                ...
                <div className='flex w-[100%] justify-center sm:gap-10 mt-10'>
                    ...
                    <div className='w-[25%]'>
                        ...
                        <div class="mb-5">
                            ...
                            <input onChange={handleChange} name="dateofbirth" type="text" id="contact" class="shadow-sm bg-red-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder={userData.dateofbirth} />
                        </div>
                        <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input onChange={handleChange} name="healthissue" type="text" id="img" class="shadow-sm bg-red-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder={userData.healthissue} />
                        </div>
                        <div class="mb-5">
                    ...
                    <div className='w-[25%]'>
                        ...
                        <div class="mb-5">
                            ...
                            <input onChange={handleChange} name="reasonofdeath" type="text" id="contact" class="shadow-sm bg-red-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder={userData.reasonofdeath} />
                        </div>
                        <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input onChange={handleChange} name="time" type="text" id="contact" class="shadow-sm bg-red-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder={userData.time} />
                        </div>
                        <div class="mb-5">
