...
export const User = () => {
    ...
    useEffect(() => {
        let fetchdata = async () => {
            let response = await axios.get(`https://lifelink-backend-evaw.onrender.com/user/vwuser`)
    ...
    return (
        <div className='images2 w-[100%] h-[45rem]'>
            <div className='text-center font-bold pt-10 text-red-800 text-xl'>USER</div>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    <Link to={`/admin/viewuser/${item._id}`}>
                                        View
                                    </Link>
                                </a>
                            </td>
